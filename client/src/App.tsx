  ...
  if (isLoading) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fafafa' }}>
        <div style={{ width: 32, height: 32, border: '2px solid #9e18a6', borderTopColor: 'transparent', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
      </div>
    );
  }
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/vaccinations/upcoming" element={<ProtectedRoute><VaccinationsPage /></ProtectedRoute>} />
          <Route path="/vaccinations/overdue" element={<ProtectedRoute><VaccinationsPage /></ProtectedRoute>} />
          
          <Route path="/medical-records" element={<ProtectedRoute><MedicalRecordsPage /></ProtectedRoute>} />
          <Route path="/medical-records/:animalId" element={<ProtectedRoute><MedicalRecordsPage /></ProtectedRoute>} />
